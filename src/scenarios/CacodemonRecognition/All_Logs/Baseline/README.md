...
**Successfully Trained?**: Yes, but not as refined as `1_3`.  Model preemptively shoots before actually getting the cacodemon in its sight.
...
As curriculum learning was a bad idea, this model will serve as the fresh training for level 2 for comparison with level 1 training. Will keep the trained model regardless, but will just make a clear distinction.

**Successfully Trained?**: Yes, model_2275000.zip
...
# BASELINE RETRAINING WITH DIFFERENT SEEDS

This section will detail the retraining of the two levels of baseline this time using three different seeds to prove that the models actually learn. 

The model parameters that trained the best will be used again. Thus, naming conventions will use the same name with the seed now appended at the end.


# LEVEL 1

## Cacodemon_Recognition_1_3_427
...
## Cacodemon_Recognition_1_3_2153
...
## Cacodemon_Recognition_2_7_21

**Successfully Trained?**: Yes, model_3475000.zip
...
## Cacodemon_Recognition_2_7_5

**Successfully Trained?**: Yes, model_3175000.zip
