...
def main(test = "false"):
    ...
    if test == "true":
        ...
        tb_log_name = f"Cacodemon_Recognition_"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description = """
            \n\n
            This file is for training active vision models on the Cacodemon Recognition scenario task level 1.
            """,
            
            epilog = "Example: python -m active_vision_model_training.active_visual_model_training_lvl_1")
