...
- All commands run to generate model performance files can be found in the [`evaluate_models.sh` file](https://github.com/BattmannWann/The-VizDoom-Experience/blob/main/src/scenarios/CacodemonRecognition/training_files/model_evaluation/evaluate_models.sh)

- Model performance for each of these can be recorded using the [`record_performance.sh` file](https://github.com/BattmannWann/The-VizDoom-Experience/blob/main/src/scenarios/CacodemonRecognition/training_files/model_evaluation/record_performance.sh)
